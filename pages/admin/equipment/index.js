...
function index() {
  ...
  const getData = async () => {
    try {
      const res = await fetch( `http://localhost:4000/api/fitnessequipment/getData`, {
          method: "GET",
  ...
  const handleDelete = async(_id)=> {
    ...
    try {
      const res = await fetch( `http://localhost:4000/api/fitnessequipment/deleteData/${_id}`, {
          method: "DELETE",
          headers: { "Content-Type": "application/json", },
        }
      );
                ...
                <div className="accent-gray">
                  <div className="row pt-4">
                    ...
                    <div className="col-xl-3">
                       <Link href="/admin/equipment/addNew">
                    ...
                    <tbody>
                      ...
                      {mealData.map((meal, index) => (
                        <tr>
                          ...
                          <td>{meal.date}</td>
                          <td>
                           <Link href={`/admin/equipment/${meal._id}`}><a><EditIcon sx={{ color: pink[500] }} /> </a></Link>
                          </td>
                          <td>
